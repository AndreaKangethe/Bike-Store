...
SECRET_KEY = 'django-insecure-f$#8%yh(mf)x3++xgc0%wb$hev!l@0p*f4aqvxfu!&3175i5!@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

CSRF_TRUSTED_ORIGINS = [
    "https://72a0-102-0-14-238.ngrok-free.app"
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'store' / 'templates' / 'store'],  # Change this
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "store/static",  # Make sure Django knows where to find static files
]
